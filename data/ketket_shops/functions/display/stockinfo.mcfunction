tellraw @s ["","[",{text:"Player Shop",color:"green"},"]",{text:" Stocked Item : ",color:"gold"},{"score":{"name":"@e[tag=interaction,tag=playershop,sort=nearest,limit=1,distance=..1]","objective":"currentstock"},bold:1b,color:"yellow"},{text:"/",bold:1b,color:"yellow"},{"score":{"name":"@e[tag=interaction,tag=playershop,sort=nearest,limit=1,distance=..1]","objective":"totalstock"},bold:1b,color:"yellow"}]
